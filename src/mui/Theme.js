...
theme.typography.h4[theme.breakpoints.up("md")] = { fontSize: "30px", fontWeight: 500}
...
theme.typography.h4[theme.breakpoints.only("sm")] = { fontSize: "31px", fontWeight: 500 }
...
theme.typography.h4[theme.breakpoints.only("xs")] = { fontSize: "24px" , fontWeight: 500}
